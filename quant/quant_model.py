...
class QuantModel(nn.Module):
    ...
    def quant_module_refactor(self, module: nn.Module, weight_quant_params: dict = {}, act_quant_params: dict = {}, depth=0):
        """
        ...
        for name, child_module in module.named_children():
            # print("quant", "-"*depth, name)
            # if name not in ['conv1', 'conv2', 'fc', 'layer4', 'layer1', 'layer2', 'layer3', '0', '1', 'downsample', 'bn1', 'avgpool', 'relu']:
            if name in ['relu']:
            ...
            if type(child_module) in specials:
                ...
                self.quant_module_refactor(child_module, weight_quant_params, act_quant_params, depth+1)
